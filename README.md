...
[![MCP Scorecard: 90/100](https://img.shields.io/badge/proofof.ai-90%2F100-5b21b6)](https://proofof.ai/scorecard/meok-w3c-tdm-rights-mcp.html)
...
```json
{
  "mcpServers": {
    "meok-w3c-tdm-rights-mcp": {
      "command": "uvx",
      "args": ["meok-w3c-tdm-rights-mcp"]
    }
  }
}
```

Or: `pip install meok-w3c-tdm-rights-mcp` then run the `meok-w3c-tdm-rights-mcp` command (stdio transport).

## Examples

Once configured, ask your assistant, for example:
- "Use `issue_tdm_reservation` to …"
- "Use `scan_url_for_reservation` to …"
- "Use `verify_c2pa_do_not_train` to …"
<!-- BUY-LADDER:END -->
